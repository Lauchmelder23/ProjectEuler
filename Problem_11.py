...
string = "00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00\n\
...
for c in string:
    if c == " ":
        numbers[len(numbers) - 1].append(int(number))
        number = ""
    elif c == "\n":
        numbers.append([])
    else:
...
for y in range(3, len(numbers)-4):
    for x in range(0, len(numbers[y])-4):
